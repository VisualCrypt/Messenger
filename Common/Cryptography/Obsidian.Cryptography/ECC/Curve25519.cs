...
namespace Obsidian.Cryptography.ECC
{
    sealed class Curve25519
    {
        ...
        public Curve25519(IPlatform platform)
        {
            _platform = platform;
        }
        ...
        /// </summary>
        /// <param name="clampedPrivateKey">private key (must use ClampPrivateKey first!)</param>
        public static byte[] GetPublicKey(byte[] clampedPrivateKey)
        {
         ...
         * Using this class instead of long[10] to avoid bounds checks. */
         /// <summary>
         /// long = 64bit = 8 bytes, Long10 = 10x8 bytes = 80 bytes
         /// </summary>
