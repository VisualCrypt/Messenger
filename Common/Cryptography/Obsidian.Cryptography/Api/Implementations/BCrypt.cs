...
// Copyright (c) 2015 Claus Ehrenberg
// 
...
// Based on: http://bcrypt.codeplex.com/, BCrypt.Net R7 date Thu Nov 21, 2013 at 9:00 AM 
// tip as of commit d05159e21ce0, Nov 21, 2013.
// Unneeded parts for the purpose (e.g. Base64 encoding) stripped and minimal 
// refactoring (parameter types, casing) by Claus Ehrenberg, 21.05.2015.
...
namespace Obsidian.Cryptography.Api.Implementations
{
    ...
    {
        #region public static API (adapted for VisualCrypt)
        ...
        static readonly uint[] BfCryptCiphertext =
        {
        ...
        #region private instance fields and methods
