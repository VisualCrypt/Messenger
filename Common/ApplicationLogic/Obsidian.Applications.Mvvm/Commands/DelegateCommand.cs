...
namespace Obsidian.Applications.Mvvm.Commands
{
    /// <summary>
    ...
    public class DelegateCommand<T> : DelegateCommandBase
    {
        ...
        DelegateCommand(Func<T, Task> executeMethod)
            : this(executeMethod, (o) => true)
        {
        }

        DelegateCommand(Func<T, Task> executeMethod, Func<T, bool> canExecuteMethod)
            : base((o) => executeMethod((T)o), (o) => canExecuteMethod((T)o))
        {
            if (executeMethod == null || canExecuteMethod == null)
                throw new ArgumentNullException("executeMethod", "DelegateCommandDelegatesCannotBeNull");
    ...
    public class DelegateCommand : DelegateCommandBase
    {
        ...
        DelegateCommand(Func<Task> executeMethod)
            : this(executeMethod, () => true)
        {
        }

        DelegateCommand(Func<Task> executeMethod, Func<bool> canExecuteMethod)
            : base((o) => executeMethod(), (o) => canExecuteMethod())
        {
            if (executeMethod == null || canExecuteMethod == null)
                throw new ArgumentNullException("executeMethod", "DelegateCommandDelegatesCannotBeNull");
